...
__decorate([
    ...
    (0, class_validator_1.IsNotEmpty)({ message: "email/phone must not  be empty" }),
...
__decorate([
    ...
    (0, class_validator_1.IsPhoneNumber)(null, { message: "please provide a valid phone number, would you?" }),
    __metadata("design:type", String)
